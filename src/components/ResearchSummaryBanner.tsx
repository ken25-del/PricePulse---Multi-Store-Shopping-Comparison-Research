      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3">
            <div className="bg-zinc-50 dark:bg-[#181818] border border-zinc-200 dark:border-[#282828] p-2.5 rounded-lg">
              <div className="text-zinc-600 dark:text-zinc-400 text-[11px] font-mono uppercase tracking-wider flex items-center gap-1">
                <ShoppingBag className="w-3 h-3 text-[#FF3E00] dark:text-[#FF9575]" />
                <span>Groups Identified</span>
              </div>
              <div className="text-lg font-black font-mono-num text-zinc-900 dark:text-white mt-0.5">
            ...
            <div className="bg-zinc-50 dark:bg-[#181818] border border-zinc-200 dark:border-[#282828] p-2.5 rounded-lg">
              ...
              <div className="text-lg font-black font-mono-num text-emerald-600 dark:text-emerald-400 mt-0.5">
                ₹{summary.lowestPrice.toLocaleString('en-IN')}{' '}
                <span className="text-[10px] text-zinc-600 dark:text-zinc-400 font-normal truncate block sm:inline">
        ...
        {bestOverall && (
          <div className="lg:w-72 w-full shrink-0 bg-orange-50/70 dark:bg-[#1a1412] border border-orange-200 dark:border-[#442217] p-3.5 rounded-xl flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="flex items-center gap-1 text-[11px] font-mono font-black uppercase text-[#FF3E00] dark:text-[#FF9575]">
            ...
            <div className="flex items-center gap-2 mt-3 pt-2.5 border-t border-orange-200 dark:border-[#381f16]">
              {onSelectProduct && (
                <button
                  type="button"
              ...
              {onOpenDecisionGuide && (
                <button
                  ...
                  className="py-1.5 px-2.5 bg-white dark:bg-[#251712] hover:bg-orange-100 dark:hover:bg-[#341e17] text-[#FF3E00] dark:text-[#FF9575] border border-orange-300 dark:border-[#52291b] font-mono text-xs font-bold uppercase rounded-md transition-colors flex items-center gap-1 cursor-pointer shadow-xs"
                >

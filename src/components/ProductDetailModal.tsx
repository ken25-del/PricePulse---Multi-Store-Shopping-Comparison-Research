...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[92vh] flex flex-col bg-white dark:bg-[#0d0d0d] rounded-xl shadow-2xl border border-zinc-200 dark:border-[#262626] overflow-hidden text-zinc-900 dark:text-[#f4f4f4] my-auto transition-colors">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between px-5 py-3.5 border-b border-zinc-200 dark:border-[#242424] bg-white/95 dark:bg-[#0d0d0d]/95 backdrop-blur-md font-mono">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-sm text-[10px] font-black uppercase tracking-wider bg-amber-50 dark:bg-[#1f1510] text-[#FF3E00] dark:text-[#FF9575] border border-amber-200 dark:border-[#442217]">
              {listings.length} STORES COMPARED
            </span>
            {productGroup.savingsPercent >= 10 && (
              <span className="px-2.5 py-0.5 rounded-sm text-[10px] font-black uppercase tracking-wider bg-emerald-50 dark:bg-[#112417] text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-[#1e4a28]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-md border text-xs font-mono font-bold transition-colors cursor-pointer ${
                isPriceTracked
                  ...
                  : 'bg-zinc-100 dark:bg-transparent hover:bg-zinc-200 dark:hover:bg-[#1a1a1a] border-zinc-300 dark:border-[#303030] text-zinc-700 dark:text-zinc-300 hover:text-amber-500'
              }`}
            >
              {isPriceTracked ? (
                <>
            ...
            <button
              ...
              className={`p-2 rounded-md border transition-colors cursor-pointer ${
                isWishlisted
                  ...
                  : 'bg-zinc-100 dark:bg-transparent hover:bg-zinc-200 dark:hover:bg-[#1a1a1a] border-zinc-300 dark:border-[#303030] text-zinc-700 dark:text-zinc-300'
              }`}
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 rounded-md hover:bg-zinc-100 dark:hover:bg-[#1a1a1a] border border-zinc-300 dark:border-[#303030] text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-5 space-y-3">
              <div className="w-full h-72 sm:h-80 rounded-lg overflow-hidden bg-zinc-100 dark:bg-[#141414] border border-zinc-200 dark:border-[#282828]">
                <img
                  src={selectedImage}
                  ...
                  {productGroup.galleryImages.slice(0, 5).map((img, i) => (
                    <button
                      ...
                      className={`w-14 h-14 rounded-md overflow-hidden border-2 shrink-0 transition-all cursor-pointer ${
                        selectedImage === img
                          ? 'border-[#FF3E00]'
                          : 'border-zinc-200 dark:border-[#282828] opacity-60 hover:opacity-100'
                      }`}
                    >
            ...
            <div className="md:col-span-7 space-y-4">
              <div>
                ...
                <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-white mt-1 leading-snug tracking-tight">
                  {productGroup.canonicalTitle}
                </h2>
              </div>

              {/* Price Range Strip */}
              <div className="p-3.5 rounded-lg bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#2a2a2a] flex items-center justify-between font-mono">
                <div>
                  <div className="text-[10px] uppercase font-bold text-zinc-500 dark:text-zinc-400">PRICE ACROSS STORES:</div>
                  <div className="text-xl font-black text-zinc-900 dark:text-white font-mono-num">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs font-black text-[#FF3E00] dark:text-[#FF9575]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 text-xs font-mono">
                {productGroup.material && (
                  <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                    <span className="text-zinc-500 block text-[10px] uppercase font-bold">FABRIC</span>
                    <strong className="text-zinc-900 dark:text-white">{productGroup.material}</strong>
                  </div>
                )}
                {productGroup.color && (
                  <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                    <span className="text-zinc-500 block text-[10px] uppercase font-bold">COLOR</span>
                    <strong className="text-zinc-900 dark:text-white">{productGroup.color}</strong>
                  </div>
                )}
                {productGroup.occasion && (
                  <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                    <span className="text-zinc-500 block text-[10px] uppercase font-bold">OCCASION</span>
                    <strong className="text-zinc-900 dark:text-white">{productGroup.occasion}</strong>
                  </div>
                )}
                <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                ...
                <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                  ...
                  <strong className="text-emerald-600 dark:text-emerald-400">{productGroup.platformScore} / 10</strong>
                </div>
                <div className="p-2.5 rounded-md bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626]">
                  <span className="text-zinc-500 block text-[10px] uppercase font-bold">REVIEW CONFIDENCE</span>
                  <strong className={productGroup.reviewConfidence === 'high' ? 'text-cyan-600 dark:text-cyan-400' : 'text-zinc-700 dark:text-zinc-300'}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Why This Product */}
            <div className="p-4 rounded-xl bg-emerald-50/70 dark:bg-[#121c14] border border-emerald-200 dark:border-[#1f4227] space-y-2">
              <div className="flex items-center gap-1.5 font-mono font-bold uppercase tracking-wider text-emerald-800 dark:text-emerald-400 text-xs">
              ...
              {productGroup.positiveThemes && productGroup.positiveThemes.length > 0 && (
                <div className="pt-2 border-t border-emerald-200 dark:border-[#1f4227]/60 space-y-1">
                  <span className="text-[10px] font-mono font-bold uppercase text-emerald-700 dark:text-emerald-300 block">Verified Highlights:</span>
            ...
            {/* Things to Consider */}
            <div className="p-4 rounded-xl bg-amber-50/70 dark:bg-[#1c1612] border border-amber-200 dark:border-[#4a2e1d] space-y-2">
              <div className="flex items-center gap-1.5 font-mono font-bold uppercase tracking-wider text-amber-800 dark:text-amber-400 text-xs">
              ...
              {productGroup.negativeThemes && productGroup.negativeThemes.length > 0 && (
                <div className="pt-2 border-t border-amber-200 dark:border-[#4a2e1d]/60 space-y-1">
                  <span className="text-[10px] font-mono font-bold uppercase text-amber-700 dark:text-amber-300 block">Buyer Notes:</span>
          ...
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-3">
              <h3 className="text-xs font-mono font-black uppercase tracking-wider text-zinc-800 dark:text-zinc-200 flex items-center gap-1.5">
            ...
            <div className="overflow-x-auto border border-zinc-200 dark:border-[#262626] rounded-xl bg-white dark:bg-[#101010]">
              <table className="w-full text-xs text-left">
                <thead className="bg-zinc-50 dark:bg-[#161616] text-zinc-700 dark:text-zinc-300 font-mono font-bold uppercase tracking-wider border-b border-zinc-200 dark:border-[#262626] text-[11px]">
                  <tr>
                ...
                <tbody className="divide-y divide-zinc-200 dark:divide-[#222222]">
                    ...
                    return (
                      <tr
                        ...
                        className={`transition-colors font-mono ${
                          isLowest
                            ? 'bg-emerald-50/60 dark:bg-[#0e2114] font-medium'
                            : 'hover:bg-zinc-50 dark:hover:bg-[#161616]'
                        }`}
                      >
                        {/* Store */}
                        <td className="p-3.5">
                          <div className="font-bold text-zinc-900 dark:text-white flex items-center gap-1.5">
                            ...
                            {isLowest && (
                              <span className="px-2 py-0.5 text-[9px] font-black uppercase rounded-xs bg-emerald-500 text-black">
                                LOWEST PRICE
                              </span>
                            )}
                          </div>
                          {item.seller && (
                            <div className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">SELLER: {item.seller}</div>
                          )}
                        </td>

                        {/* Price */}
                        <td className="p-3.5 font-mono-num">
                          <div className={`font-black ${isLowest ? 'text-emerald-600 dark:text-emerald-400 text-base' : 'text-zinc-900 dark:text-zinc-100 text-sm'}`}>
                        ...
                        <td className="p-3.5 font-mono">
                          {isLowest ? (
                            <span className="text-emerald-700 dark:text-emerald-400 font-bold text-[11px] bg-emerald-100 dark:bg-emerald-950/60 px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-800/60">
                              ✓ Best Deal
                            </span>
                          ) : (
                            <span className="text-amber-800 dark:text-amber-300 font-bold text-[11px] bg-amber-100 dark:bg-[#291b15] px-2 py-0.5 rounded border border-amber-200 dark:border-[#4d2d1e]">
                        ...
                        <td className="p-3.5">
                          {item.discountPercent ? (
                            ...
                            <span className="text-zinc-500 dark:text-zinc-400">Standard</span>
                          )}
                          {item.mrp && item.mrp > item.price && (
                            <div className="text-[10px] text-zinc-400 dark:text-zinc-500 line-through">
                        ...
                        <td className="p-3.5">
                          <div className="flex items-center gap-1 font-bold text-zinc-900 dark:text-white">
                            ...
                            <span className="text-zinc-500 dark:text-zinc-400 text-[10px]">({item.reviewCount})</span>
                          </div>
                        </td>
                        ...
                        <td className="p-3.5">
                          <div className="flex items-center gap-1.5 text-[11px] text-zinc-700 dark:text-zinc-300">
                            <Truck className="w-3.5 h-3.5 text-zinc-500 dark:text-zinc-400 shrink-0" />
                          ...
                          <div className="flex items-center gap-1.5 text-[10px] text-zinc-500 dark:text-zinc-400 mt-1">
                            <RotateCcw className="w-3.5 h-3.5 text-zinc-400 dark:text-zinc-500 shrink-0" />
                              ...
                              <button
                                ...
                                className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md text-xs font-mono font-bold transition-all cursor-pointer border ${
                                  isListingTracked && isListingTracked(item.storeId)
                                    ...
                                    : 'bg-zinc-100 dark:bg-[#1e1e1e] hover:bg-zinc-200 dark:hover:bg-[#2a2a2a] text-zinc-700 dark:text-zinc-300 hover:text-amber-600 dark:hover:text-amber-400 border-zinc-300 dark:border-[#333333]'
                                }`}
                              >
                                {isListingTracked && isListingTracked(item.storeId) ? (
                                  <>
                            ...
                            <a
                              ...
                              className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-md text-xs font-mono font-black uppercase tracking-wider transition-transform active:scale-95 shadow-sm cursor-pointer ${
                                isLowest
                                  ...
                                  : 'bg-zinc-800 dark:bg-[#262626] hover:bg-zinc-900 dark:hover:bg-[#363636] text-white border border-zinc-700 dark:border-[#3a3a3a]'
                              }`}
                            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 font-mono">
            {/* AI Review Summary */}
            {reviewSummary && (
              <div className="p-4 rounded-lg bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#262626] space-y-3">
                <div className="flex items-center gap-1.5 font-bold uppercase tracking-wider text-[#FF3E00] dark:text-[#FF9575] text-xs">
                ...
                {reviewSummary.commonConcerns.length > 0 && (
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-wider text-[#FF3E00] dark:text-[#FF9575] block mb-1">
                      {t.commonConcerns}:
                    </span>
                    <ul className="space-y-1 text-xs text-zinc-700 dark:text-zinc-300 font-sans">
            ...
            {/* AI Verdict */}
            {verdict && (
              <div className="p-4 rounded-lg bg-orange-50/60 dark:bg-[#161210] border border-orange-200 dark:border-[#3b2118] space-y-3">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-sm text-[9px] font-black uppercase tracking-wider ${
                      verdict.status === 'recommended'
                        ? 'bg-emerald-100 text-emerald-800 border border-emerald-300 dark:bg-[#122b19] dark:text-emerald-300 dark:border-[#21572f]'
                        : verdict.status === 'consider'
                        ? 'bg-amber-100 text-amber-900 border border-amber-300 dark:bg-[#331c12] dark:text-[#FF9575] dark:border-[#663520]'
                        : 'bg-rose-100 text-rose-800 border border-rose-300 dark:bg-[#331215] dark:text-rose-300 dark:border-[#632027]'
                    }`}
                  >
                ...
                {verdict.riskAlerts.length > 0 && (
                  <div className="p-2 rounded bg-orange-100/80 dark:bg-[#241510] text-[11px] text-orange-900 dark:text-[#FF9575] border border-orange-300 dark:border-[#4d2619]">
          ...
          <div className="flex items-start gap-2 p-3 rounded-lg bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-[#222222] text-[11px] text-zinc-500 dark:text-zinc-400 font-mono">
            <Info className="w-3.5 h-3.5 shrink-0 mt-0.5 text-zinc-400 dark:text-zinc-500" />

  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-4xl bg-[#0e0e0e] border-2 border-[#2b2b2b] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] text-zinc-100 font-sans"
      >
        ...
        {/* Modal Header */}
        <div className="p-5 sm:p-6 pb-4 border-b border-[#222222] bg-[#121212]/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-[#FF3E00]/15 border border-[#FF3E00]/30 text-[#FF3E00] text-[10px] font-mono font-black tracking-widest uppercase">
          ...
          <button
            ...
            className="self-end sm:self-center p-2 rounded-lg bg-[#1a1a1a] hover:bg-[#282828] text-zinc-400 hover:text-white border border-[#333333] transition-colors cursor-pointer"
        ...
        {/* Tab Navigation */}
        <div className="px-5 sm:px-6 pt-3 border-b border-[#222222] bg-[#101010] flex items-center gap-2 overflow-x-auto no-scrollbar font-mono text-xs font-bold uppercase tracking-wider">
          <button
            type="button"
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 flex-1 bg-[#0b0b0b]">
          ...
          {activeTab === 'why_not_extensions' && (
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="rounded-xl border border-[#262626] overflow-hidden bg-[#111111]">
                ...
                <div className="divide-y divide-[#202020] text-xs">
                  {/* Row 1 */}
                  <div className="p-3 grid grid-cols-12 gap-2 items-center">
                    <div className="col-span-4 font-semibold text-zinc-300">
                    ...
                    <div className="col-span-4 flex items-center gap-1.5 text-emerald-400 font-bold">
                  ...
                  {/* Row 2 */}
                  <div className="p-3 grid grid-cols-12 gap-2 items-center bg-[#131313]">
                    <div className="col-span-4 font-semibold text-zinc-300">
                      {isHindi ? 'मल्टी-स्टोर डिस्कवरी' : 'Cross-Store Scanning'}
                    </div>
                    <div className="col-span-4 flex items-center gap-1.5 text-zinc-400">
          ...
          {activeTab === 'features_tour' && (
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Feature 1 */}
                <div className="p-4 rounded-xl bg-[#141414] border border-[#282828] space-y-2 hover:border-[#FF3E00]/50 transition-colors">
                ...
                {/* Feature 2 */}
                <div className="p-4 rounded-xl bg-[#141414] border border-[#282828] space-y-2 hover:border-emerald-500/50 transition-colors">
                  <div className="flex items-center gap-2 text-emerald-400 font-mono font-black text-xs uppercase tracking-wider">
                ...
                {/* Feature 3 */}
                <div className="p-4 rounded-xl bg-[#141414] border border-[#282828] space-y-2 hover:border-cyan-500/50 transition-colors">
                  <div className="flex items-center gap-2 text-cyan-400 font-mono font-black text-xs uppercase tracking-wider">
                ...
                {/* Feature 4 */}
                <div className="p-4 rounded-xl bg-[#141414] border border-[#282828] space-y-2 hover:border-amber-400/50 transition-colors">
        ...
        <div className="p-4 sm:p-5 border-t border-[#222222] bg-[#121212] flex flex-col sm:flex-row items-center justify-between gap-4">
          <label className="flex items-center gap-2 text-xs text-zinc-400 cursor-pointer select-none">
            <input
              type="checkbox"
              checked={dontShowAgain}
              onChange={handleCheckboxChange}
              className="rounded-xs border-zinc-700 bg-black text-[#FF3E00] focus:ring-0 w-4 h-4 cursor-pointer"
            />
